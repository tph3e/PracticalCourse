...
class RoundRobinResourceAllocation(AllocationStrategy):
    ...
    def allocate(
        ...
        **kwargs: Any,
        ...
        last_assigned_resource_id: str | None = None
        ...
        for resource in ordered_resources:
            ...
            last_assigned_resource_id = resource.resource_id
            decisions.append(
                AllocationDecision(
                    resource_id=resource.resource_id,
        ...
        if last_assigned_resource_id is not None:
            self._next_resource_id = self._successor_resource_id(
                available_resources,
                last_assigned_resource_id,
            )
